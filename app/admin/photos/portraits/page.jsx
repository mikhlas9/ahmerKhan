    ...
    <div className="min-h-screen bg-gray-50 p-6 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow p-6 md:p-8 mb-6">
          ...
          <p className="text-gray-600">Add, edit, and delete your portrait photos</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <div>
              <h2 className="text-xl font-semibold text-gray-900">Portraits</h2>
            </div>
            <button
              onClick={handleNew}
          ...
          {showForm && (
            <form ref={formRef} onSubmit={handleSubmit} className="mb-6 p-6 border border-gray-200 rounded-lg bg-gray-50">
              <h2 className="text-xl font-semibold mb-4">{editingId ? "Edit Portrait" : "New Portrait"}</h2>
          ...
          {loading ? (
            ...
            <div className="text-center py-12 text-gray-500">
              No portraits found. Click "+ New Portrait" to add one.
            </div>
          ) : (
...
export default function AdminPhotosPortraitsPage() {
  return (
    <AdminAuthWrapper>
      <AdminPhotosPortraits />
    </AdminAuthWrapper>
  )
}
